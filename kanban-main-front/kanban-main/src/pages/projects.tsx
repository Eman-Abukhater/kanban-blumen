...
export default function ProjectsList() {
  ...
  const handleDeleteProject = async () => {
    ...
    try {
      ...
      saveProjectsToCache(prevProjects);

      toast.update(toastId, {
        render: e?.message || "Failed to delete project.",
        type: "error",
        isLoading: false,
        autoClose: 3000,
      });
  ...
  "
                ...
                <button
                  ...
                  className="btn rounded-[10px] bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 hover:opacity-95"
                >
                  Delete
                </button>
