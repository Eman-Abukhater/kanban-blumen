...
export default function ProjectsList() {
    ...
    try {
      ...
      if (cached) {
        ...
        if (Array.isArray(parsed)) {
          setProjects(parsed);
          // show content immediately if cached exists
          setIsLoading(false);
        }
      }
    } catch {
  ...
  // ✅ show skeleton only if loading lasts >150ms (better UX, feels instant)
  useEffect(() => {
    if (isLoading) {
  ...
  // ✅ IMPORTANT: render shell always (avoid blank delay while userInfo loads)
  return (
    <>
      <Shell>
        <Topbar />
                    ...
                    <>
                      ...
                      {paginated.map((project: any) => (
                        ...
                        >
                          ...
                          <div className="w-16 dark:text-slate500_80">
                          ...
                          <div className="w-24 dark:text-[#FFFFFF]">20+</div>
